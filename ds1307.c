...
void init_ds1307(void)
{
    ...
    //write_ds1307(HOUR_ADDR, 0x50);      //for 10 am   0101 0000
                                        //bit6 - 1  ->12hr  bit5 -0 ->am
   // write_ds1307(HOUR_ADDR, 0x50);      //for 10 pm   0101 0000
      write_ds1307(HOUR_ADDR, dummy&0xBf);      //for 18    0001 1000
	/* 
